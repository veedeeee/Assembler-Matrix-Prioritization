...
- Run NeoForge (MC 1.21.1) client: `.\gradlew.bat :neoforge:runClient --console=plain`
- Run NeoForge (MC 2.6.12) client: `.\gradlew.bat :neoforge2612:runClient --console=plain`
