...
- [ ] All release tests pass (see `release-test-scenarios.md`)
  - [ ] B-NF-211 PASS
  - [ ] B-FG-201 PASS
- [x] MOD icon ready ΓÇö `images/mod_logo.png`
- [ ] Changelog written
...
- [ ] Create new project: <https://authors.curseforge.com/#/projects/create/choose-game>
  ...
  - [ ] Logo image: upload 256├ù256px icon
- [x] Note down the **Project ID** — CurseForge: `1631512`

### File Upload

- [ ] Navigate to project ΓåÆ Files tab ΓåÆ Upload File
- [ ] Upload NeoForge jar
...
- [ ] Create new project from dashboard
  ...
  - [ ] Icon: upload 256├ù256px icon
- [ ] Note down the **Project ID / slug** (needed for Gradle automation)

### Version Upload

- [ ] Navigate to project ΓåÆ Versions ΓåÆ Create version
- [ ] Upload NeoForge jar
  - [ ] File: `assembler-matrix-prioritization-neoforge-*.jar`
...
- [ ] Upload Forge jar
  ...
  - [ ] Changelog: paste changelog
  - [ ] Dependencies (required): `Applied Energistics 2`, `ExtendedAE`
- [ ] Confirm status changes to `processing` ΓåÆ `approved`
